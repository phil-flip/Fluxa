...
<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <tr>
        <th class="pl-6 py-3 text-left" scope="col">
            <label class="flex" for="hs-at-with-checkboxes-main">
    ...
    <tr>
        <td class="h-px w-px whitespace-nowrap">
            <div class="pl-6 py-2">
                <label class="flex" for="hs-at-with-checkboxes-9">
                    <input class="shrink-0 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
        ...
        <td class="h-px w-px whitespace-nowrap">
            <div class="px-6 py-2">
                <a class="text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500"
                   href="/projects/FLX">Fluxa</a>
            </div>
        </td>
        <td class="h-px w-px whitespace-nowrap">
            <div class="px-6 py-2">
                <span class="text-sm text-gray-600 dark:text-gray-400">Public beta - Oct 1
                </span>
            </div>
        </td>
        <td class="h-px w-px whitespace-nowrap">
            <div class="px-6 py-2">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-400">Nick Stemerdink</span>
            </div>
        </td>
        <td class="h-px w-px whitespace-nowrap">
                ...
                <div class="group inline-flex items-center divide-x divide-gray-300 border border-gray-300 bg-white shadow-sm rounded-md transition-all dark:divide-gray-700 dark:bg-slate-700 dark:border-gray-700">
                    <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                        <button class="hs-dropdown-toggle py-1.5 px-2 inline-flex justify-center items-center gap-2 rounded-r-md text-gray-700 align-middle focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-gray-800 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800" id="hs-table-dropdown-9"
                                type="button">
                            <svg class="w-4 h-4" fill="currentColor" height="16"
                                 viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
                            </svg>
                        </button>
                        <div aria-labelledby="hs-table-dropdown-9"
    ...
    <div>
        <div class="inline-flex gap-x-2">
            <button class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
                    type="button">
                <svg class="w-3 h-3" fill="currentColor" height="16" viewBox="0 0 16 16"
