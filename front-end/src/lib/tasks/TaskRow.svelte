...
<div aria-haspopup="menu"
    ...
    <div class="cell">
        {#if status.name === 'Done'}
                <span class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
        ...
        {:else if status.name === 'In progress'}
                <span class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs bg-yellow-100 text-yellow-900 dark:bg-gray-900 dark:text-gray-200">
                    {status.name}
                </span>
        {:else}
                <span class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
                    {status.name}
                </span>
        {/if}
    </div>
